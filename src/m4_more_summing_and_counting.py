...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 0
    answer = count_cosines_from(8, 11, .9)
    ...
    # Test 4:
    expected = 1
    answer = count_cosines_from(2, 5, 0.1)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 1
    answer = count_cosines_from(5, 6, 0.6)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 0
    answer = count_cosines_from(14, 16, 0.8)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 0.3511655  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(10, 13)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = 2.2833333  # This is APPROXIMATELY the correct answer.
